$(document).on 'turbolinks:load', ->
  ...
  if action_name == 'show'
    $('.main_content resource_form input').prop('disabled', true);
    $('.main_content resource_form textarea').prop('disabled', true);
    $('.main_content resource_form select').prop('disabled', true);
