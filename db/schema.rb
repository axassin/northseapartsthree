...
ActiveRecord::Schema.define(version: 20170208060632) do
  ...
  create_table "holiday_types", id: :string, limit: 36, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.datetime "deleted_at"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "remark",              limit: 64
    ...
    t.index ["deleted_at"], name: "index_holiday_types_on_deleted_at", using: :btree
  end
